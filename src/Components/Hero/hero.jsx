...
return (
    <div className='hero container'>
        <div className='hero-text'>
            ...
            <a href='https://www.texus.io/event/2511' target='__onblank'><button className='btn'><b>🚀 404 - Logic Not Found : Prove your brilliance— Register Now!</b><img src={arrow} alt="" /></button></a>
        </div>
    </div>
)
}
